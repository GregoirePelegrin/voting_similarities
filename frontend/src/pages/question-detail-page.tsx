    ...
    <AnimatedPage>
      <Box sx={{ mb: 3 }}>
        ...
        <Box sx={{ display: "flex", alignItems: "center", gap: 1, mb: 1 }}>
          <Chip
            label={q.has_passed ? "Passed" : "Not Passed"}
            size="small"
            sx={{
        ...
        <Typography variant="body2" color="text.secondary">
          Yes: {q.total_yes} · No: {q.total_no} · Missing: {q.total_missing}
        </Typography>
      </Box>

      <Card sx={{ bgcolor: "background.paper", p: 3 }}>
        <Typography variant="h6" sx={{ mb: 2 }}>Group Breakdown</Typography>
          ...
          <Box key={gs.group_id} sx={{ mb: 1.5 }}>
            <Box sx={{ display: "flex", justifyContent: "space-between", mb: 0.5 }}>
              ...
              <Typography variant="caption" color="text.secondary">
                {gs.yes_count}Y / {gs.no_count}N / {gs.missing_count}-
              </Typography>
            </Box>
